    ...
    <div class="min-h-full">
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <!-- Current: "bg-gra-y900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="flex justify-between items-center px-2 pb-3 pt-2 sm:px-3">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Prosen</div>
                            <div class="text-sm font-medium text-gray-400">prosenjit1156@gmail.com</div>
                        </div>
                        <button type="button"
